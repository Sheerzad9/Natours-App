...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hlZXJ6YWQxMCIsImEiOiJja3hsdm40ZXcxODk4MnFvNXhlaHh3bDI1In0.hjwpNCczsAzkezOF4lrdjQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sheerzad10/ckxlvw1nx0qyu14p3ihwtqyka',
    scrollZoom: false //   center: [-118.262075, 34.020161],
    //   zoom: 10,
    //   interactive: false
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KCmQiCKKzrvuCuGbEvhebfVx27RtzGLB5GmQHhi1lLuYGo0TKG0eWf4NaUiYKzDMKUZCSthNQsOmKJrAgXxirvy00kSdZ74Ff');
            _context.prev = 1;
            _context.next = 4;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save password'; // Here we clear the fields
